...
<form method="post" action="/transaksi/store">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="nama_transaksi" placeholder="Nama Transaksi">
    </div>

    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label">Jenis Transaksi</label>
        <input type="text" class="form-control" name="jenis_transaksi" placeholder="Jenis Transaksi">
    </div>
