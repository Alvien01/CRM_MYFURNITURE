...
<form method="post" action="/transaksicustomer/update">
    @csrf
    <div class="mb-3">
        ...
        <option selected disabled>Pilih Customer</option>
            @foreach($datacustomer as $item)
                ...
                @if($item->id_customer == $userData->id_customer)
                selected
                @endif
    ...
    <input type="hidden" name="id" value="{{$userData->id_transaksi_customer}}">
